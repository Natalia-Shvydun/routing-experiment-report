...
# MAGIC %md
# MAGIC # Forecast Deviation Analysis — Full Period
# MAGIC
# MAGIC Backtest the forecasting model across the full data period (Aug 2025 →
# MAGIC Feb 2026) to understand long-term accuracy trends, seasonal patterns,
# MAGIC and systematic bias by dimension.
...
RESULT_TABLE = "testing.analytics._forecast_deviation_cart_level"
BATCH_SIZE = 5
